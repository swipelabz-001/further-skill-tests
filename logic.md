...
oO Its position will always be the same

oO Its position will be set according to the document layout flow

oO Its position will be based on the <html> element or its nearest positioned ancestor.
oO Its position will be based relative to the browser viewport itself.

Oo The element will to act like it is relatively positioned until it is scrolled to a certain threshold point (e.g. 10px from the top of the viewport), after which it 
```
becomes fixed.
```
...
oO box-sizing: content-box;
oO box-sizing: padding-box;
...
Answer:
Which property should I use to define the right margin in CSS?
...
CO bi.all {background-color: #FFFFFF}
oO h1 {background-color:#FFFFFF}
� None of the above
?Given the following media query
```
@media only screen and (min-width: 320px)
and (max-width: 480px) {} which of the following statements is true
```
Answer:

oO The media query is not valid

oO It will be applied to every device

oO It will be available to every device larger than 320px and smaller than 480px;
oO It will be available to every device larger than 480px

oO It will be available to every device smaller than 320px
